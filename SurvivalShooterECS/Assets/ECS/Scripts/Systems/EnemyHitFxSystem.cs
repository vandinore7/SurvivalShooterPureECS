...
// ComponentType.ReadOnly<EnemyData>(), ComponentType.ReadOnly<DamagedData>(),
// ComponentType.ReadOnly<AudioSource>()); }

// protected override void OnUpdate() { Entities.With(query).ForEach( (Entity entity, AudioSource
// audio, ref DamagedData damagedData) => { audio.Play();
